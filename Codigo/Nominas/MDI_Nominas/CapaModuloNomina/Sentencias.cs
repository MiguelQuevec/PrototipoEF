...
namespace CapaModuloNomina
{
    public class Sentencias
    {
        ...
        public OdbcDataAdapter llenarListaClientes(string tabla)
        {
            string sql = "select  pk_id_cliente as ID, Nombre_cliente AS Nombre from tbl_cliente;";
            OdbcDataAdapter datatable = new OdbcDataAdapter(sql, con.conexion());
            return datatable;
        }

        public OdbcDataAdapter llenarListaProductos(string tabla)
        {
            string sql = "select pk_id_producto as ID, Nombre_producto AS Producto, Precio_producto AS Precio from tbl_producto;";
            OdbcDataAdapter datatable = new OdbcDataAdapter(sql, con.conexion());
            return datatable;
        }
