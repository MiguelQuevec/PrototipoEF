...
namespace CapaControladorNomina
{
    public class Controlador
    {
        ...
        public void llenarListCliente(string ntabla, DataGridView tabla)
        {
            OdbcDataAdapter dt = sn.llenarListaClientes(ntabla);
            DataTable table = new DataTable();
            dt.Fill(table);
            tabla.DataSource = table;
        }

        public void llenarListProducto(string ntabla, DataGridView tabla)
        {
            OdbcDataAdapter dt = sn.llenarListaProductos(ntabla);
            DataTable table = new DataTable();
            dt.Fill(table);
            tabla.DataSource = table;
        }
